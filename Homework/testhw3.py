...
if not(valor_propiedad < 1500 or valor_propiedad > 13000):
...
if not(pie_porcentaje < 20 or pie_porcentaje > 45):
...
if not(plazo != 20 and plazo != 25 and plazo != 30):
...
if tipo_vivienda != 1 and tipo_vivienda != 2:
